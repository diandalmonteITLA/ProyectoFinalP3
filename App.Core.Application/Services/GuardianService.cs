...
namespace App.Core.Application.Services
{
    public class GuardianService : IGuardianService
    {
        ...
        public async Task AddAsync(CreateGuardianDto createGuardianDto)
        {
            ...
            if (!_phoneNumberValidator.ValidateNumber(createGuardianDto.PhoneNumbers.First().Number))
            {
        ...
        public async Task UpdateAsync(UpdateGuardianDto updateGuardianDto)
        {
            ...
            if (!_phoneNumberValidator.ValidateNumber(updateGuardianDto.PhoneNumbers.First().Number))
            {
